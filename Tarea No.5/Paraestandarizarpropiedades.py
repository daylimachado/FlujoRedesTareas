# -*- coding: utf-8 -*-
"""
Created on Mon Apr 29 19:53:58 2019
...
##Para columna del CoefAgrup 
#his,b,r = plt.hist((df["CoefAgrup"]),bins=3, density=True, facecolor='g', alpha=0.75)
#plt.xlabel ("rangos")
#plt.ylabel("cantidad de valores")
#plt.title("Histograma")
#plt.savefig("Imagenes/histCoefAgrup"+".png")
#plt.savefig("Imagenes/histCoefAgrup"+".eps")
#
#print("bins %s" % b, end="\n\n")
...
##Para columna CentCercania
#his,b,r = plt.hist((df["CentCercania"]),bins=3, density=True, facecolor='g', alpha=0.75)
#plt.xlabel ("rangos")
#plt.ylabel("cantidad de valores")
#plt.title("Histograma")
#plt.savefig("Imagenes/histCentCercania"+".png")
#plt.savefig("Imagenes/histCentCercania"+".eps")
#
#print("bins %s" % b, end="\n\n")
...
#Para columna CentCarga

#his,b,r = plt.hist((df["CentCarga"]),bins=3, density=True, facecolor='g', alpha=0.75)
#plt.xlabel ("rangos")
#plt.ylabel("cantidad de valores")
#plt.title("Histograma")
#plt.savefig("Imagenes/histCentCarga"+".png")
#plt.savefig("Imagenes/histCentCarga"+".eps")
#
#print("bins %s" % b, end="\n\n")
...
#his,b,r = plt.hist((df["ExcentCarga"]),bins=3, density=True, facecolor='g', alpha=0.75)
#plt.xlabel ("rangos")
#plt.ylabel("cantidad de valores")
#plt.title("Histograma")
#plt.savefig("Imagenes/histExcentCarga"+".png")
#plt.savefig("Imagenes/histExcentCarga"+".eps") 
#
#print("bins %s" % b, end="\n\n")
...
# Pagerange
his,b,r = plt.hist((df["PageR"]),bins=3, density=True, facecolor='g', alpha=0.75)
plt.xlabel ("rangos")
plt.ylabel("cantidad de valores")
plt.title("Histograma")
plt.savefig("Imagenes/histPageR"+".png")
plt.savefig("Imagenes/histPageR"+".eps") 

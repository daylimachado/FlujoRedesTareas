...
red=[(4,3),(3,7)]
position= {1:(0,220), 2:(150,220), 3:(75, 180), 4:(75,200), 5:(25,180),6:(125,180), 7:(75,160)}
pos = nx.spring_layout(G, pos=position, iterations=50, scale=3)
#pos = {1:(0,220), 2:(150,220), 3:(75, 180), 4:(75,200), 5:(25,180),6:(125,180), 7:(75,160)}
#pos = nx.spring_layout(G, pos, center={0,0}, scale=1) 

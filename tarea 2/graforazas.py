# -*- coding: utf-8 -*-
"""
Created on Sun Feb 24 21:24:43 2019
...
pos = nx.circular_layout(G,scale=0.09) 
...
nx.draw_networkx_nodes(G, pos, nodelist=node_au, node_size=4100, node_color='r', node_shape='o')
